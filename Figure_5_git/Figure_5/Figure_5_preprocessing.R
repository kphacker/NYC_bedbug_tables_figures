#preprocessing for Figure_5

#complaints by borough standardized by population 
...
###geography cosinor analysis - Bedbug complaints 
...
#opulation size estimates per borough per year 
...
pop <- data.frame("year" = c(2019:2014), "bronx" = bronx, 
                  ...
                  "queens" = queens, "staten_island" = statan_island, stringsAsFactors = FALSE)
...
write.csv(count_all, "BB_complaints_borough_year_pop.csv")